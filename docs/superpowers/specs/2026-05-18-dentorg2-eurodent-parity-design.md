# DentOrg2 — Paridad funcional Eurodent: Diseño completo

**Fecha:** 2026-05-18
**Proyecto:** DentOrg2 (FastAPI + SQLAlchemy + PostgreSQL / React + Vite + TypeScript)
**Objetivo:** Completar el flujo clínico-administrativo de DentOrg2 para que cubra todas las funciones clave de Eurodent, con organización moderna.
