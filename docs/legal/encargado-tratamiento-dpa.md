...
No es contrato legal. Es una matriz tecnica para preparar el DPA de DentOrg2.

## Implementado

- DentOrg2 puede operar como encargado para una clinica responsable del tratamiento.
