# DentCore Product Master

## Vision

DentCore Clinic es la herramienta central de la clinica dental. Su trabajo es ordenar el dia real de recepcion, doctores, administracion y pacientes sin convertir cada funcion en una pantalla principal.
...
DentCore debe funcionar como un sistema de ventanas/modulos compactos:
