...
$env:BACKUP_EXTERNAL_COPY_DIR="C:\backups-dentorg2-externos"
...
.\.venv\Scripts\python.exe -m scripts.backup_tool verify --file <backup.dentorg2bak> --expected-hash <sha256>
```
