...
import type { PortalPublicConsentimiento } from '../../../api/types';
import { cancelarPortalPublicCita, confirmarPortalPublicCita, firmarPortalPublicConsentimiento, getPortalPublicCitas, getPortalPublicConsentimientos, getPortalPublicDocumentos, openPortalPublicDocumento, solicitarCambioPortalPublicCita, validatePortalInvitation } from '../../../api/portal';
