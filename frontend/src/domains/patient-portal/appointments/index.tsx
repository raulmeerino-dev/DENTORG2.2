...
import { cancelarPortalCita, confirmarPortalCita, firmarPortalConsentimiento, getPortalCitas, getPortalConsentimientos, getPortalDocumentos, getPortalMe, solicitarCambioPortalCita } from '../../../api/portal';
import { getPacientes } from '../../../api/patients';
import { openConsentimientoPdf } from '../../../api/consents';
import { openDocumentoPaciente } from '../../../api/documents';
