...
vi.mock('../../../api/scheduling', () => ({
  marcarLlegadaCita: vi.fn(), iniciarAtencionCita: vi.fn(), resolverSalidaCita: vi.fn(),
  confirmarCita: vi.fn(),
...
describe('HoyPage flujo operativo', () => {
  ...
  it('prioriza la jornada real y conserva el acceso directo a nueva cita', async () => {
    ...
    await waitFor(() => {
      ...
      expect(within(dailySummary).getByText('Sin confirmar').closest('button')).toHaveTextContent('1');
