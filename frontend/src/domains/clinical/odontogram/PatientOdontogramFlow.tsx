...
import { getOdontogramaPaciente, updateOdontogramaPieza, updateOdontogramaSuperficie } from '../../../api/odontogram';
import { invalidatePatientWorkspaceQueries } from '../../../shared/query/queryInvalidation';
import type { ApiPaciente, OdontogramaSurfaceName, UserRole } from '../../../api/types';
