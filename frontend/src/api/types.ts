...
export interface Cita {
  ...
  doctor_id: string;
  gabinete_id: string | null;
  gabinete_nombre?: string | null;
  presupuesto_linea_id?: string | null;
  fecha_hora: string;
  duracion_min: number;
  estado: string;
  estado_operativo?: EstadoOperativoCita;
  llegada_at?: string | null;
  atencion_iniciada_at?: string | null;
  finalizada_at?: string | null;
  salida_resuelta_at?: string | null;
  pendiente_salida?: boolean;
  es_urgencia?: boolean;
  solape_urgencia?: boolean;
  motivo: string | null;
  observaciones?: string | null;
...
export interface Gabinete { id: string; nombre: string; activo: boolean }
