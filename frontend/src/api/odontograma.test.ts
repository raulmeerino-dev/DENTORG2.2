...
import { confirmarPortalCita, solicitarCambioPortalCita } from './portal';
import { cancelarCitaAvanzada, createCita, marcarFaltaCita, reprogramarCita, updateHorarioDoctor } from './scheduling';
import { createClinica } from './identity';
import { createOdontogramaPaciente, createPresupuestoFromOdontograma, duplicateOdontogramaVersion, saveOdontograma, updateOdontogramaPieza, updateOdontogramaSuperficie } from './odontogram';
import { createProductoInventario } from './inventory';
import { registrarFichaje } from './workforce';
