...
const DEMO_FAMILIAS: FamiliaTratamiento[] = [
  { id: 'fam-prev', nombre: 'Diagnostico y Prevencion', icono: 'DP', orden: 1 },
  { id: 'fam-cons', nombre: 'Odontologia Conservadora', icono: 'OC', orden: 2 },
  { id: 'fam-endo', nombre: 'Endodoncia', icono: 'EN', orden: 3 },
  { id: 'fam-impl', nombre: 'Implantologia', icono: 'IM', orden: 4 },
  { id: 'fam-orto', nombre: 'Ortodoncia', icono: 'OR', orden: 5 },
  { id: 'fam-est', nombre: 'Estetica Dental', icono: 'ES', orden: 6 },
];

const DEMO_TRATAMIENTOS: TratamientoCatalogo[] = [
  { id: 't-limp', familia_id: 'fam-prev', familia: DEMO_FAMILIAS[0], codigo: 'LI01', nombre: 'Limpieza bucal con pulido', precio: '75.00', iva_porcentaje: '0.00', requiere_pieza: false, requiere_caras: false, activo: true },
  { id: 't-emp', familia_id: 'fam-cons', familia: DEMO_FAMILIAS[1], codigo: 'EM02', nombre: 'Empaste composite 2 caras', precio: '90.00', iva_porcentaje: '0.00', requiere_pieza: true, requiere_caras: true, activo: true },
  { id: 't-endo', familia_id: 'fam-endo', familia: DEMO_FAMILIAS[2], codigo: 'EN01', nombre: 'Endodoncia unirradicular', precio: '220.00', iva_porcentaje: '0.00', requiere_pieza: true, requiere_caras: false, activo: true },
  { id: 't-impl', familia_id: 'fam-impl', familia: DEMO_FAMILIAS[3], codigo: 'IM01', nombre: 'Colocacion de implante dental', precio: '950.00', iva_porcentaje: '0.00', requiere_pieza: true, requiere_caras: false, activo: true },
  { id: 't-orto', familia_id: 'fam-orto', familia: DEMO_FAMILIAS[4], codigo: 'OR07', nombre: 'Control mensual ortodoncia', precio: '40.00', iva_porcentaje: '0.00', requiere_pieza: false, requiere_caras: false, activo: true },
  { id: 't-blan', familia_id: 'fam-est', familia: DEMO_FAMILIAS[5], codigo: 'BL01', nombre: 'Blanqueamiento profesional', precio: '180.00', iva_porcentaje: '0.00', requiere_pieza: false, requiere_caras: false, activo: true },
];
...
const DEMO_PRESUPUESTOS: Presupuesto[] = [
  {
    ...
    lineas: [
      { id: 'demo-line-1', presupuesto_id: 'demo-pres-1', tratamiento_id: 't-limp', tratamiento: DEMO_TRATAMIENTOS[0], pieza_dental: null, caras: null, precio_unitario: '75.00', descuento_porcentaje: '0.00', aceptado: true, pasado_trabajo_pendiente: true, importe_neto: '75.00' },
      { id: 'demo-line-2', presupuesto_id: 'demo-pres-1', tratamiento_id: 't-endo', tratamiento: DEMO_TRATAMIENTOS[2], pieza_dental: 24, caras: null, precio_unitario: '220.00', descuento_porcentaje: '0.00', aceptado: true, pasado_trabajo_pendiente: false, importe_neto: '220.00' },
      { id: 'demo-line-3', presupuesto_id: 'demo-pres-1', tratamiento_id: 't-impl', tratamiento: DEMO_TRATAMIENTOS[3], pieza_dental: 37, caras: null, precio_unitario: '950.00', descuento_porcentaje: '0.00', aceptado: false, pasado_trabajo_pendiente: false, importe_neto: '950.00' },
    ],
    total: '1245.00',
    total_aceptado: '295.00',
  },
];
...
const DEMO_FACTURAS: Factura[] = [
  {
    ...
    lineas: [{ id: 'demo-fl-1', concepto: 'Limpieza bucal y endodoncia', concepto_ficticio: '24', cantidad: 1, precio_unitario: '295.00', iva_porcentaje: '0.00', subtotal: '295.00' }],
...
const DEMO_HISTORIAL: HistorialClinico[] = [
  {
    ...
    tratamiento: { id: 't-limp', nombre: DEMO_TRATAMIENTOS[0].nombre, codigo: DEMO_TRATAMIENTOS[0].codigo },
  ...
  },
  {
    ...
    importe: '150.00',
    factura_id: null,
    tratamiento: { id: 't-endo', nombre: DEMO_TRATAMIENTOS[2].nombre, codigo: DEMO_TRATAMIENTOS[2].codigo },
